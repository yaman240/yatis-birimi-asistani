...
import { onAuthStateChanged, sendPasswordResetEmail, signInWithEmailAndPassword, signInWithPopup, signOut } from "https://www.gstatic.com/firebasejs/11.10.0/firebase-auth.js";
...
onAuthStateChanged(auth, async user => {
  ...
  stopCurrentProfileSubscription = userProfiles.subscribeByUid(user.uid, async profile => {
    ...
    if (!profile) {
      ...
      authorizationNotice.innerHTML = "<strong>Hesabınız henüz yetkilendirilmemiş.</strong>Sistem yöneticisinin onayını bekleyin.";
      setConnectionStatus("Yetkilendirme bekleniyor.");
